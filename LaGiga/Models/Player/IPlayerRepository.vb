...
Public Interface IPlayerRepository
    ...
    Function CreatePlayer(ByVal PlayerToCreate As Player) As Player
    Function DeletePlayer(ByVal PlayerToDelete As Player) As Player
    Function EditPlayer(ByVal PlayerToEdit As Player) As Player
