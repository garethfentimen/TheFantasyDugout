...
Public Class AccountControllerTest
    ...
    '    ' Arrange
    '    Dim controller As AccountController = GetAccountController()
    '    Dim model As LaGigaRegisterIndexModel = New LaGigaRegisterIndexModel()
    '    model.RegModel.UserName = "someUser"
    '    model.RegModel.Email = "goodEmail"
    '    model.RegModel.Password = "goodPassword"
    '    model.RegModel.ConfirmPassword = "goodPassword"
    ...
    '    Dim controller As AccountController = GetAccountController()
    '    Dim model As LaGigaRegisterIndexModel = New LaGigaRegisterIndexModel()
    '    model.RegModel.UserName = "duplicateUser"
    '    model.RegModel.Email = "goodEmail"
    '    model.RegModel.Password = "goodPassword"
    '    model.RegModel.ConfirmPassword = "goodPassword"
